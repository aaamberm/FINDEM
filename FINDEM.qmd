...
```
 ...
 Ferritin missing data is expected due to errors on the analyser and samples not handled properly. Hb has a maximum value of of 999, ferritin of \~2000. Hb maximum of 999 is an NA, technically ferritin maximum value is possible. We adjust the data to account for this.
...
data_clean %>%
  na.omit() %>% 
  dplyr::select(-KeyID, -stap2, -Meetweek, -Cluster, -HbDef, -Timepoint, -Step, -Weight, -Height, -Intervention_months,-COVID, -Donatiedatum, -ReturnOpTijd, -Intervention_months2, -Intervention_months_factor, -Step) %>%
