...
We decide to proceed with the analyses using standard linear regression models using only fixed effects, thus disregarding the random effects from clustering by donation center cluster. We made this decision based on:
