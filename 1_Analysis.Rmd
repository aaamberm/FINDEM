...
oud <- read_sav("Donaties_3meetweken_test.sav")
data_raw <- read_sav("Donaties_4meetweken_plus.sav") #using my project folder structure, adapt to yours.
...
# select
data_raw2 <- data_raw %>% select(KeyID, Hb, HbGoedgekeurd, Ferritine_FINDEM, stap, Meetweek, cluster, Geslacht, Gewicht, Lengte, LeeftijdBijDOnatie, ReturnOpTijd, Return)
