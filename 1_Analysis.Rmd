...
ferrgood_fitFfactor <- update(ferrgood_fitF, formula = Ferritingood ~ Age + Weight + Height + as.factor(Intervention_months))
ferrgood_fit_preF_factor <- update(ferrgood_fitF, formula = Ferritingood ~ Age + Weight + Height + as.factor(Intervention_months), subset = data_scale$Gender == "Female" & data_scale$PostMeno == 0)
ferrgood_fit_postF_factor <- update(ferrgood_fitF, formula = Ferritingood ~ Age + Weight + Height + as.factor(Intervention_months), subset = data_scale$Gender == "Female" & data_scale$PostMeno == 1)
...
ferrgood_fitMfactor <- update(ferrgood_fitF, formula = Ferritingood ~ Age + Weight + Height + as.factor(Intervention_months))
